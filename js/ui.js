...
function setTradeMode(mode){
  ...
  `;
  render(); // update trade button colors
}
...
function render() {
  ...
  setTradeMode(tradeMode); // ensure toggle is correct
}
